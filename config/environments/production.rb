Rails.application.configure do
  ...
  config.action_controller.asset_host = 'https://linhser.herokuapp.com'
  ...
  # config.active_job.queue_name_prefix = "webser_production"
  ...
  config.action_mailer.default_url_options = { host: 'https://linhser.herokuapp.com' }
