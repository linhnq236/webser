...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { content: @reminder.content, end_time: @reminder.end_time, start_time: @reminder.start_time } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { content: @reminder.content, end_time: @reminder.end_time, start_time: @reminder.start_time } }
