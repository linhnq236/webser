...
class RegulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create regulation" do
    assert_difference('Regulation.count') do
      post regulations_url, params: { regulation: { description: @regulation.description, title: @regulation.title } }
    end
  ...
  test "should update regulation" do
    patch regulation_url(@regulation), params: { regulation: { description: @regulation.description, title: @regulation.title } }
